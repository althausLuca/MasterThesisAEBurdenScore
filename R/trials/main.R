...
group_values <- simulate_group(AEs, size=1000,  susceptibility_parameter = list("constant") , max_time=180)
...
scores.sorted <- group_values$scores[order(group_values$scores)]
susceptibility.sorted <- group_values$susceptibility[order(group_values$scores)]
score.1 <- mean(scores.sorted)

plot(scores.sorted, log(susceptibility.sorted), xlab = "Score", ylab = "Susceptibility Log", main="gamma-k 1")
...
scores.sorted <- group_values$scores[order(group_values$scores)]
susceptibility.sorted <- group_values$susceptibility[order(group_values$scores)]
score.0.1 <- mean(scores.sorted)

plot(scores.sorted, log(susceptibility.sorted), xlab = "Score", ylab = "Susceptibility Log", main="gamma-k 0.1")
...
scores.sorted <- group_values$scores[order(group_values$scores)]
susceptibility.sorted <- group_values$susceptibility[order(group_values$scores)]
score.10 <- mean(scores.sorted)
plot(scores.sorted, log(susceptibility.sorted), xlab = "Score", ylab = "Susceptibility Log" , main="gamma-k 10")
