...
plot_ae <- function(ae_data, color = "green", max_time = 180, by = 10, save = "", death = FALSE) {
  ...
  #add score to plot
  g <- g + geom_text(aes(x = 5, y = 4.5, label = paste("Score:", ae_data$score)), size = 4, hjust = 0)
...
plot_ae(ae_data_2.1, color = "limegreen", save = "ae21.png", death = TRUE)
plot_ae(ae_data_2.2, color = "tomato", save = "ae22.png", death = TRUE)
